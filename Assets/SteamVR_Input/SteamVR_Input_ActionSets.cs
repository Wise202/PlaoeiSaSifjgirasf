...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Elementary p_Elementary;
        ...
        public static SteamVR_Input_ActionSet_Elementary Elementary
        {
            get
            {
                return SteamVR_Actions.p_Elementary.GetCopy<SteamVR_Input_ActionSet_Elementary>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Elementary = ((SteamVR_Input_ActionSet_Elementary)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Elementary>("/actions/Elementary")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Elementary};
        }
    }
}
